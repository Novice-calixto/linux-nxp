...
#define THREAD_SCTLR_USER 4384 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4280 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4360 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4376 /* offsetof(struct task_struct, thread.mte_ctrl) */
